      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="glass-panel p-6 rounded-xl border-t-2 border-t-brand-cyan">
              <div className="text-3xl font-display font-bold text-white mb-1">MVP</div>
              <div className="text-xs font-mono text-gray-400 uppercase tracking-wider">Aegis Health AI in testing</div>
            </div>
            <div className="glass-panel p-6 rounded-xl border-t-2 border-t-brand-violet">
              <div className="text-3xl font-display font-bold text-white mb-1">Full-Stack</div>
              <div className="text-xs font-mono text-gray-400 uppercase tracking-wider">Architecture &amp; Design</div>
            </div>
            <div className="glass-panel p-6 rounded-xl border-t-2 border-t-brand-green">
              <div className="text-3xl font-display font-bold text-white mb-1">5+ Yrs</div>
              <div className="text-xs font-mono text-gray-400 uppercase tracking-wider">Creative Direction</div>
            </div>
            <div className="glass-panel p-6 rounded-xl border-t-2 border-t-brand-amber">
              <div className="text-3xl font-display font-bold text-white mb-1">Solo</div>
              <div className="text-xs font-mono text-gray-400 uppercase tracking-wider">System Builder</div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <a href="mailto:dhurianiket@gmail.com" className="flex items-center gap-4 p-4 glass-panel rounded-xl hover:bg-brand-cyan/5 hover:border-brand-cyan/30 hover:shadow-[0_0_20px_rgba(0,240,255,0.2)] transition-all duration-300 group">
              ...
              <div>
                ...
                <div className="text-xs font-mono text-gray-400">dhurianiket@gmail.com</div>
              </div>
